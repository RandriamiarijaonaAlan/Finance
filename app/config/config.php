...
Flight::register('db','PDO',array('mysql:host=localhost;dbname=AgenceImmobiliere','root',''));
// Flight::register('db','PDO',array('mysql:host=localhost;dbname=db_s2_ETU003287','ETU003287','JvV7A296'));
